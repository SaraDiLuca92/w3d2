...
function sommalettere(string1, string2) {
  let result = string1.slice(0, 2) + string2.slice(-3);
  return result.toUpperCase();
}

console.log(sommalettere("ciao", "mondo"));
...
*/
let arraynum = [10, 6, 8, 9, 32, 40, 11, 15];
const filtro = arraynum.filter((elemento) => {
  return elemento % 2 === 0;
});
console.log(filtro);
...
const sommaarray1 = array1.reduce(
...
*/
let n = 19;
let numerii = [1, 3, 9, 10, 7];
const numeriii = (x, y) => x.push(y);

console.log(numerii, n);
